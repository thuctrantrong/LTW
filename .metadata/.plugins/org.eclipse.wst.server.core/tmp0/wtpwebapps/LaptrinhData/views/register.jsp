...
<body>
  <div class="register-container">
        ...
        <form class="modal-content animate" action="/LaptrinhData/register" method="post">
            <div>
            ...
            <div>
				...
				<label for="imagines">Imagines:</label>
            	<input type="text" id="imagines" name="imagines" required>
			<div>
